...
GRN Lab: https://learning.praxislxp.com/praxis/alex_prxai_com/2021/03/23/linking-gcn-edges-with-a-grn/

UTERNINE: https://academic.oup.com/g3journal/article/12/1/jkab392/6427626

https://github.com/feltus/linking-gcn-edges-with-a-grn
...
Visualize the network in Cystoscape.
Install sqlite3 database software.
```
...
# Step E. Start the sqlite3 shell and create the database called mapping.
```
sqlite3 mapping
```

# Step F. Using the sqlite shell, load 3 tables into the mapping database (grn, gcn, names)
```
.separator "\t"
.import grn.tab grn
.separator "\t"
...
# Step G. Make an INNER JOIN to create a tab-delimited GRN file with the target gene mapped to official gene symbols.  Note that Structured Query Language (SQL) tutorials are all over the Internet.  Here is one example: https://www.w3schools.com/sql/sql_intro.asp. 
...
# Step H. Make a merged GRN and GCN edge list with bash.
